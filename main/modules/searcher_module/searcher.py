class Searcher:
	...
	def search_duplicates(self, list_of_images_to_look_for):
		...
		Keyword arguments:
		list_of_images_to_look_for -- A list of image objects that will be examined in order to find duplicates
		
		Returned value:
		name_of_images_duplicated -- It will return the list of names of the images duplicated. For now it returns the same images received
