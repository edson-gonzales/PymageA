...
class TestListImages(unittest.TestCase):
	...
	def test_list_images_in_specified_scope_of_specified_directory(self):
		...
		list_of_images_from_get_all_images_from_path = self.list_images.get_all_images_from_path(self.test_path)
	...
	def test_list_images_in_specified_scope_of_specified_directory_and_nested_directories(self):
		...
		list_of_current_images_on_directory = ['Image4.jpg','Image1.jpg','Image2.png','Image3.bmp','Image1.jpg','Image2.png','Image3.bmp','Image1.jpg','Image2.png','Image3.bmp']
		list_of_images_from_get_all_images_from_path = self.list_images.get_all_images_from_path(self.test_path)
	...
	def test_list_images_returns_images_and_not_directories(self):
		...
		list_of_images_from_get_all_images_from_path = self.list_images.get_all_images_from_path(self.test_path)
		self.assertEquals(list_of_current_images_on_nested_directories,list_of_images_from_get_all_images_from_path )
